(function() {
    ...
    if ("undefined" != typeof process && process.nextTick) {
        ...
        async.setImmediate = "undefined" != typeof setImmediate ? setImmediate : async.nextTick;
    ...
    var _eachLimit = function(limit) {
        return function(arr, iterator, callback) {
            ...
            (function replenish() {
                ...
                while (limit > running && arr.length > started) {
                    started += 1;
                    running += 1;
    ...
    async.doWhilst = function(iterator, test, callback) {
        iterator(function(err) {
            if (err) return callback(err);
            test() ? async.doWhilst(iterator, test, callback) : callback();
        });
    };
    ...
    async.doUntil = function(iterator, test, callback) {
        iterator(function(err) {
            if (err) return callback(err);
            test() ? callback() : async.doUntil(iterator, test, callback);
        });
    };
