var CryptoJS = CryptoJS || function(g, l) {
    var e = {}, d = e.lib = {}, m = function() {}, k = d.Base = {
        ...
        concat: function(a) {
            ...
            a = a.sigBytes;
            this.clamp();
            if (f % 4) for (var b = 0; a > b; b++) c[f + b >>> 2] |= (255 & q[b >>> 2] >>> 24 - 8 * (b % 4)) << 24 - 8 * ((f + b) % 4); else if (q.length > 65535) for (b = 0; a > b; b += 4) c[f + b >>> 2] = q[b >>> 2]; else c.push.apply(c, q);
            this.sigBytes += a;
            return this;
        },
        clamp: function() {
        ...
        random: function(a) {
            for (var c = [], b = 0; a > b; b += 4) c.push(0 | 4294967296 * g.random());
        ...
        stringify: function(a) {
            var c = a.words;
            a = a.sigBytes;
            for (var b = [], f = 0; a > f; f++) b.push(String.fromCharCode(255 & c[f >>> 2] >>> 24 - 8 * (f % 4)));
            return b.join("");
        },
        parse: function(a) {
...
(function() {
    ...
    g.algo.HMAC = g.lib.Base.extend({
        init: function(e, d) {
            ...
            d.clamp();
            for (var p = this._oKey = d.clone(), b = this._iKey = d.clone(), n = p.words, j = b.words, h = 0; g > h; h++) n[h] ^= 1549556828, 
            j[h] ^= 909522486;
...
(function() {
    ...
    h.enc.Base64 = {
        stringify: function(b) {
            ...
            b.clamp();
            b = [];
            for (var a = 0; f > a; a += 3) for (var d = (255 & e[a >>> 2] >>> 24 - 8 * (a % 4)) << 16 | (255 & e[a + 1 >>> 2] >>> 24 - 8 * ((a + 1) % 4)) << 8 | 255 & e[a + 2 >>> 2] >>> 24 - 8 * ((a + 2) % 4), g = 0; 4 > g && f > a + .75 * g; g++) b.push(c.charAt(63 & d >>> 6 * (3 - g)));
